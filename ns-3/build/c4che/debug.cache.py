...
ARFLAGS = 'rcs'
CC = ['/usr/bin/gcc']
CCDEFINES = ['NDEBUG', 'NDEBUG', 'NS3_ASSERT_ENABLE', 'NS3_LOG_ENABLE']
CCDEFINES_ST = '-D%s'
CCFLAGS = ['-O0', '-g0', '-O0', '-g0', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
CCFLAGS_DEBUG = ['-g']
...
COMPILER_CXX = 'g++'
CPP = '/usr/bin/cpp'
CPPPATH_PYEMBED = ['/Library/Frameworks/Python.framework/Versions/2.7/include/python2.7']
CPPPATH_PYEXT = ['/Library/Frameworks/Python.framework/Versions/2.7/include/python2.7']
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES = ['NDEBUG', 'NS3_ASSERT_ENABLE', 'NS3_LOG_ENABLE']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-O0', '-g0', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
CXXFLAGS_DEBUG = ['-g']
...
HAVE_UINT128_T = ()
HAVE___UINT128_T = 1
LIBPATH_PYEMBED = ['/Library/Frameworks/Python.framework/Versions/2.7/lib']
LIBPATH_PYEXT = ['/Library/Frameworks/Python.framework/Versions/2.7/lib']
LIBPATH_PYTHON2.7 = ['/Library/Frameworks/Python.framework/Versions/2.7/lib']
LIBPATH_ST = '-L%s'
LIB_PYEMBED = ['dl', 'python2.7']
LIB_PYEXT = ['dl', 'python2.7']
...
NS3_BUILDDIR = '/Users/chunxiaomu/Documents/LS_DV_Routing/ns-3/build'
...
PYTHON_CONFIG = '/Library/Frameworks/Python.framework/Versions/2.7/bin/python2.7-config'
PYTHON_VERSION = '2.7'
...
defines = {'HAVE_PYTHON_H': 1, 'HAVE___UINT128_T': 1, 'HAVE_SYS_SOCKET_H': 1, 'HAVE_SIGNAL_H': 1, 'HAVE_NETINET_IN_H': 1, 'HAVE_GETENV': 1, 'HAVE_IF_TUN_H': (), 'HAVE_INTTYPES_H': 1, 'PYTHONDIR': '"/usr/local/lib/python2.7/site-packages"', 'HAVE_UINT128_T': (), 'HAVE_STDLIB_H': 1, 'HAVE_PTHREAD_H': 1, 'HAVE_STDINT_H': 1, 'HAVE_SYS_INT_TYPES_H': (), 'HAVE_PACKET_H': (), 'USE_HIGH_PRECISION_128': 1}
